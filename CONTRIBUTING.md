...
Open an issue using our [issue template](https://github.com/PremierLangage/platon-front/issues/new?assignees=&labels=Question&template=question.md&title=%Question%5D+) for general support questions.
...
You can file new issues by filling out our [new issue form](https://github.com/PremierLangage/platon-front/issues/new/choose).


### <a name="submit-pr"></a> Submitting a Pull Request (PR)
Before you submit your Pull Request (PR) consider the following guidelines:

* Search [GitHub](https://github.com/PremierLangage/platon-front/pulls) for an open or closed PR
...
* Run the full platon-front test suite <!-- , as described in the [developer documentation][dev-doc] -->, and ensure that all tests pass.
...
* In GitHub, send a pull request to `platon-front:master`.
* If we suggest changes then:
  * Make the required updates.
  * Re-run the platon-front test suites to ensure tests are still passing.
...
Samples: (even more [samples](https://github.com/PremierLangage/platon-front/commits/master))
