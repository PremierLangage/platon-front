...
export const WEB_COMPONENTS_BUNDLES: LazyComponentDef[] = [
    ...
    { selector: 'wc-platon-viewer', loadChildren: () => import( /* webpackChunkName: "wc-platon-viewer" */ './widgets/platon-viewer/platon-viewer.module').then(m => m.PlatonViewerModule) },
];
