...
export const WEB_COMPONENTS_BUNDLES: NgeElementDef[] = [
    ...
    { selector: 'wc-automaton-viewer', module: () => import(/* webpackChunkName: "wc-automaton-viewer" */ './widgets/automaton-viewer/automaton-viewer.module').then(m => m.AutomatonViewerModule) },
    { selector: 'wc-checkbox-group', module: () => import(/* webpackChunkName: "wc-checkbox-group" */ './forms/checkbox-group/checkbox-group.module').then(m => m.CheckboxGroupModule) },
    { selector: 'wc-code-editor', module: () => import(/* webpackChunkName: "wc-code-editor" */ './forms/code-editor/code-editor.module').then(m => m.CodeEditorModule) },
    { selector: 'wc-code-viewer', module: () => import(/* webpackChunkName: "wc-code-viewer" */ './widgets/code-viewer/code-viewer.module').then(m => m.CodeViewerModule) },
    { selector: 'wc-graph-viewer', module: () => import( /* webpackChunkName: "wc-graph-viewer" */ './widgets/graph-viewer/graph-viewer.module').then(m => m.GraphViewerModule) },
    { selector: 'wc-hint', module: () => import(/* webpackChunkName: "wc-hint" */ './widgets/hint/hint.module').then(m => m.HintModule) },
    { selector: 'wc-input-box', module: () => import(/* webpackChunkName: "wc-input-box" */ './forms/input-box/input-box.module').then(m => m.InputBoxModule) },
    { selector: 'wc-jsx', module: () => import(/* webpackChunkName: "wc-jsx" */ './forms/jsx/jsx.module').then(m => m.JsxModule) },
    { selector: 'wc-markdown', module: () => import(/* webpackChunkName: "wc-markdown" */ './widgets/markdown/markdown.module').then(m => m.MarkdownModule) },
    { selector: 'wc-match-list', module: () => import(/* webpackChunkName: "wc-match-list" */ './forms/match-list/match-list.module').then(m => m.MatchListModule) },
    { selector: 'wc-math-live', module: () => import(/* webpackChunkName: "wc-math-live" */ './forms/math-live/math-live.module').then(m => m.MathLiveModule) },
    { selector: 'wc-matrix', module: () => import(/* webpackChunkName: "wc-matrix" */ './forms/matrix/matrix.module').then(m => m.MatrixModule) },
    { selector: 'wc-picker', module: () => import(/* webpackChunkName: "wc-picker" */ './forms/picker/picker.module').then(m => m.PickerModule) },
    { selector: 'wc-radio-group', module: () => import(/* webpackChunkName: "wc-radio-group" */ './forms/radio-group/radio-group.module').then(m => m.RadioGroupModule) },
    { selector: 'wc-sort-list', module: () => import(/* webpackChunkName: "wc-sort-list" */ './forms/sort-list/sort-list.module').then(m => m.SortListModule) },
