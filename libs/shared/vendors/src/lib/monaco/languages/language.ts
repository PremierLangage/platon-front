...
export interface MonacoLanguageDefinition extends monaco.languages.ILanguageExtensionPoint {
...
export const MONACO_LANGUAGE_PROVIDERS = new InjectionToken<MonacoLanguageDefinition[]>('MONACO_LANGUAGE_PROVIDERS');
