...
import { DragDrop, DragDropComponentDefinition } from './drag-drop';
...
export class DragDropComponent implements OnInit, OnDestroy, WebComponentHooks<DragDrop> {
    @Input() state!: DragDrop;
